...
/**
 * g++ -Wall -g3 -O0 main.cpp -o request -I../src -lcurl -lcrypto
 * usage:
...
#define FILE_TXT "/tmp/a.txt"
#define FILE_IMG "/tmp/b.jpg"
...
int main(int argc, char* argv[])
{
    ...
    // POST (with file upload):
    {
        ...
        uploads.push_back(bgy::StringPair("filename10086", FILE_TXT));
        uploads.push_back(bgy::StringPair("filename17951", FILE_IMG));
...
void prepare()
{
    if (access(FILE_TXT, F_OK))
    {
        std::ofstream stream(FILE_TXT);
        stream << "lets upload [" FILE_TXT "]\n";
    }

    if (access(FILE_IMG, F_OK))
    {
        ...
        std::FILE* fp = std::fopen(FILE_IMG, "wb");
        if (fp)
        {
